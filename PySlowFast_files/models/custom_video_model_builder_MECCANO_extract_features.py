...
#This code is associated to the following publication:
# F. Ragusa, A. Furnari, G.M. Farinella, MECCANO: A Multimodal Egocentric Dataset
# for Humans Behavior Understanding in the Industrial-like Domain. 2022.
...
class SlowFastExtractFeatures(nn.Module):
    """
    SlowFast model builder for SlowFast network to extract features.
    ...
    def __init__(self, cfg):
        ...
        """
        super(SlowFastExtractFeatures, self).__init__()
...
class ResNetModBasicHead(nn.Module):
    ...
    def forward(self, inputs):
        ...
        #Get the linear vector feature of the video clip
        features = x
        features = features.mean([1, 2, 3])
